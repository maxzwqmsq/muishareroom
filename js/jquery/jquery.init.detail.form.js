...
(function($){  
    $.fn.extend({  
        initDetailForm:function(options){  
            //默认参数  
            var defaults = {  
                jsonValue:"",  
            ...
            if(!$.isEmptyObject(jsonValue)){  
                ...
                $.each(jsonValue,function(key,value){  
                    ...
                    if(setting.isDebug){  
                        alert("data_field_name:"+key+"; value:"+value);  
                        debugInfo += "data_field_name:"+key+"; value:"+value+" || ";  
                    }  
                    var formField = form.find("[data_field_name='"+key+"']");  
